...
const sumEvens = nums.filter((number) => {
...
const atxIdx = nums.forEach((currentValue, index) => {

  if((currentValue + index) === 512){
    console.log(index);
...
const weatherStates = weather.map((currentValue, index, arr) => {

  return currentValue.weather_state_name;

});

console.log(weatherStates.filter(uniqueValue));

//find the id of the object in weather that has a min_temp of 15.915

const idealTemp = weather.find((index) => {

  return index.min_temp === 15.915
